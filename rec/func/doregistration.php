...
$parent_email =		mysqli_escape_string($connection, $_POST['parent_email']);
$emergency_phone  =		mysqli_escape_string($connection, $_POST['emergency_phone']);
...
if(strlen($password) < 6) {	//Password must be at least 6 characters long
	$encountered = true;
...
$query = "INSERT INTO " . $user_table . " (firstname, lastname, username, password, email, activated, groups, phone, address, city, state, zipcode, parents, parent_email, emergency_phone) VALUES ('" . $firstname . "', '" . $lastname . "', '" . $username . "', '" . sha1($password) . "', '" . $email . "', '" . $regcode . "', '" . $groups . "', '" . $phone . "', '" . $address . "', '" . $city . "', '" . $state . "', '" . $zipcode . "', '" . $parents . "', '" . $parent_email . "', '" . $emergency_phone . "');";
                                    
//Execute the query
mysqli_query($connection, $query);

//Max's registration hook
include('../hook/registration.php');

//Redirect the user to the login page
//header('Location: ../../register.php?e=' . $regres);
header( 'Location: ../../register-thankyou.php' );
