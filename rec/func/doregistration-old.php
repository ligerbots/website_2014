...
if(strlen($password) < 4) {	//Password must be at least 4 characters long
	$encountered = true;
...
$query = "INSERT INTO " . $user_table . " (firstname, lastname, username, password, email, activated, groups, phone, address, city, state, zipcode, parents) VALUES ('" . $firstname . "', '" . $lastname . "', '" . $username . "', '" . sha1($password) . "', '" . $email . "', '" . $regcode . "', '" . $groups . "', '" . $phone . "', '" . $address . "', '" . $city . "', '" . $state . "', '" . $zipcode . "', '" . $parents . "');";
